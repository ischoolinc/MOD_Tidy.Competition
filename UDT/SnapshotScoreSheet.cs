...
namespace Ischool.Tidy_Competition.UDT
{
    ...
    /// 周排行對應的評分登記總表
    /// </summary>
    [TableName("ischool.tidy_competition.snapshot_score_sheet")]
    class SnapshotScoreSheet : ActiveRecord
    {
        /// <summary>
        /// 評分登記總表編號
        /// </summary>
        [Field(Field ="ref_score_sheet_id",Indexed =false)]
        public int RefScoreSheetID { get; set; }
        /// <summary>
        /// 學年度
        /// </summary>
        ...
        /// 扣分物件系統編號
        /// </summary>
        [Field(Field = "ref_deduciotn_item_id", Indexed = false)]
        ...
        /// 取消原因
        /// </summary>
        [Field(Field = "canceled_reason", Indexed = false)]
